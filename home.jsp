...
<div class="spot_section">
        ...
        <div class="special_banner" id="special_banner">
            ...
            <a href="#" target="_self" class="special_banner_link" onclick="" title="스페셜 배너">
                <img src="resources/image/main_banner.png" alt="스페셜 배너" class="special_banner_img" title="스페셜 배너">
            </a>
                ...
                <div class="member">
                    <div class="notice">
                        <div class="notice_cont">
                        	<img src="resources/image/logo_icon_miri.png" width="22px" height="22px" class="noice_tit_link" ></img>
...
<!-- ♥ 회원가입 후  -->
<div class="step01 login login_common_ly" id="login_after" style="display:none;">
	<a href="#">
		<img src="resources/image/photo.jpeg" width="110px" height="145px" style="border:1px solid lightgray; float:left">
	</a>
...
<div class="spot_col">
	...
	<a href="#" class="banner_link" onclick="clickcr(this,'pr.mobile','','',event); openLayer('mobilePRLayer'); return false;" title="게임 배너">
		<img src="resources/image/login_under_banner.png" alt="" class="banner_img" title="게임 배너">
	</a>
</div>
    ...
    <div class="spot_event">
        <a href="http://bj.hangame.com/" class="event_link" onclick="clickcr(this,'pr.horizon','','',event);" target="" title="프로모션 배너">
            <img src="resources/image/horizontal_banner.png" alt="프로모션 배너" class="event_img" title="프로모션 배너">
        </a>
    </div>
</div>
    ...
    <div class="floating_banner">
        ...
        <a href="https://mini.hangame.com/index/pc?utm_source=hangame&amp;utm_medium=floating&amp;utm_campaign=open" target="_blank" class="floating_banner_link" onclick="clickcr(this,'pr.rightwing','','',event, 1); clickcr(this,'hangame_portal.floatingbanner_20190426','','',event);" title="날개 배너">
            ...
            <img src="resources/image/wing_banner.png" alt="날개 배너" title="날개 배너" class="floating_banner_img">
        </a>
    </div>
    ...
    <div class="tit_box">
        ...
        <h2 class="comic_tit">
        	<a href="https://mix.hangame.com" onclick="clickcr(this, 'mix.logo','','',event);" target="hangameMixSite" class="tit_link">
      		  <img src="resources/image/board_tit.png" class="logo_mix">HANGAME mix
        	</a>
        </h2>
...
<div class="plus_area half_type">
    <div class="tit_box">
        <h2 class="mix_tit">
	        <a href="https://mix.hangame.com" onclick="clickcr(this, 'mix.logo','','',event);" target="hangameMixSite" class="tit_link">
	       		 <img src="resources/image/gallery_tit.png" class="logo_mix">HANGAME mix
	        </a>
        </h2>
    </div>
    <div class="mix_box">
        <ul class="game_info_lst">
                ...
                <li class="game_info_item">
                    <a href="https://mix.hangame.com/game/10053" >
                        <img src="resources/image/dog.png" width="131" height="94" alt="한게임 포커 : 레볼루션">
                    </a>
                    <div class="game_info">
                ...
                <li class="game_info_item">
                    <a href="https://mix.hangame.com/game/10053" >
                        <img src="resources/image/cat.png" width="131" height="94" alt="한게임 포커 : 레볼루션">
                    </a>
                    <div class="game_info">
