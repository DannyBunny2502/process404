                ...
                <div class="member">
                    <div class="notice">
                        <div class="notice_cont">
                            <a class="notice_tit_link" href="" onclick="NoticeBoard.go();clickcr(this,'hna.ttl','','',event);return false;">PROCESS 404</a>
...
<div class="step01 login login_common_ly" id="login_after" >
	<a href="#">
		...
		<div class ="member_info_list" style="margin: 6px 0 0 128px;">
		IT운영개발부<br>
		사원 김다은
		
			<div class="mypage">
				<input type="button" value="MyPage" style="padding: 5px 20px; margin-top: 85px; text-align: center;">
			</div>
		</div>
	
	<div class="logout">
				<input type="button" value="로그아웃" style="padding: 5px 10px; ; text-align: center;">
				<input type="button" value="정보수정" style="padding: 5px 10px; ; text-align: center;">
	</div>
</div>
    ...
    <div class="tit_box">
        ...
        <div class="comic_tab_box">
            ...
            <ul id="comicoCategoryUl" class="comic_tab">
			     ...
			     <li class="comic_tab_item is_active"><a href="#" onclick="changeTab(this, 'COMICO_000002', 1); clickcr(this, 'toon.tab1','','',event); return false;" class="comic_tab_link">공지사항<span class="blind">선택됨</span></a></li>
				  <li class="comic_tab_item"><a href="#" onclick="changeTab(this, 'COMICO_000003', 2); clickcr(this, 'toon.tab2','','',event); return false;" class="comic_tab_link">자유게시판</a></li>
