                            ...
                            <!-- <a class="notice_tit_link" href="" >PROCESS 404</a> -->
       							...
       							<span class="logout" style="margin-top:3px; float:right;">
       								<c:if test="${employee!=null}">
	       								<a href="employee/mypage/" style="float:right;">마이페이지</a>
										<a href="employee/logout/" style="float:right;">로그아웃</a> 
       								</c:if>
...
<!-- ♥ 회원가입 후  -->
	...
	<a href="#">
		<img src="${path}/resources/image/${employee.getImg_root() }" width="110px" height="145px" style="border:1px solid lightgray; float:left">
	</a>
