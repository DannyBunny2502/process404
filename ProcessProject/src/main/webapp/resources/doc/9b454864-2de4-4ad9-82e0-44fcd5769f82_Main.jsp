...
<head>
		...
		<link rel="canonical" href="https://www.hangame.com">  
...
<script type="text/javascript">
    ...
    <h1 class="top_logo">
    <a href="/">
    	<span class="nav_w"><img src="image/process404_miri.png" width="202" height="20" alt="EDIYA COFFEE"></span>
    </a>
    </h1>
                    ...
                    <div class="notice">
                        <div class="notice_cont">
                            <a class="notice_tit_link" href="" onclick="NoticeBoard.go();clickcr(this,'hna.ttl','','',event);return false;">공지</a>
                                    ...
                                    <a href="#" onclick="NoticeBoard.read(133900);clickcr(this,'hna.txt','','',event);return false;" class="notice_link">[안내] 일부 게임 로그인 불가 오류 (정상화 안내)</a>
		...
		<h2 class="blind">로그인</h2>
					<div class="login_set lg_iptxt">
						<span id="ajax_checkbox" style="cursor:pointer" class="ajax_checkbox checkbox-applied">
							<span class="checkbox-mark checkbox-checked" id="checkBoxFrame"></span>
							<input type="checkbox" name="agree" id="agree" class="chk_inp" style="visibility: visible;">
						</span>
...
<div class="spot_col">
    ...
    <div class="spot_event">
 	...
 	<div class="floating_banner_parent">
...
<div class="plus_area half_type">
    <div class="tit_box">
        <h2 class="comic_tit">
        	<a href="http://comics.hangame.com" onclick="clickcr(this, 'toon.logo','','',event);" target="hangameComics" class="tit_link">
        		<span class="logo_comic">BOARD</span>
        	</a></h2>
        <div class="comic_tab_box">
            ...
            <ul id="comicoCategoryUl" class="comic_tab">
                            ...
                            <li class="comic_tab_item is_active"><a href="#" onclick="changeTab(this, 'COMICO_000002', 1); clickcr(this, 'toon.tab1','','',event); return false;" class="comic_tab_link">웹툰<span class="blind">선택됨</span></a></li>
                            ...
                            <li class="comic_tab_item"><a href="#" onclick="changeTab(this, 'COMICO_000001', 3); clickcr(this, 'toon.tab3','','',event); return false;" class="comic_tab_link">단행본</a></li>
        ...
        <a href="#" class="mobile_guide" onclick="openLayer('mobilePRLayer'); return false;"><span class="ico_mobile">모바일 가이드 보기</span></a>
    </div>
    <div id="comicoBannerDiv" class="comic_box">
        <h3 class="blind">웹툰</h3><!-- [D] 선택된 tab의 제목과 h3 연결 (접근성) -->
        <ul id="comicoBannerUl" class="card_lst"><li class="card_item col_type3"><div class="card"><a href="http://comics.hangame.com/titles/1408" onclick="clickcr(this, 'toon.content1-1','','',event);" target="hangameComics"><span class="card_img_box"><span class="card_mask"></span><img src="https://hangame-images.toastoven.net/hangame/main2016/comics/184_246/1408_kv332x444.jpg" width="104" height="139" alt="공기심장"></span><em class="card_tit">공기심장</em></a><span class="card_txt">김종진</span></div></li><li class="card_item col_type3"><div class="card"><a href="http://comics.hangame.com/titles/2342" onclick="clickcr(this, 'toon.content1-2','','',event);" target="hangameComics"><span class="card_img_box"><span class="card_mask"></span><img src="https://hangame-images.toastoven.net/hangame/main2016/comics/184_246/2342_kv332x444.jpg" width="104" height="139" alt="하이브리드(HYBRID)"></span><em class="card_tit">하이브리드(HYBRID)</em></a><span class="card_txt">글 이순기, 그림 손영식</span></div></li><li class="card_item col_type3"><div class="card"><a href="http://comics.hangame.com/titles/111" onclick="clickcr(this, 'toon.content1-3','','',event);" target="hangameComics"><span class="card_img_box"><span class="card_mask"></span><img src="https://hangame-images.toastoven.net/hangame/main2016/comics/184_246/111_kv332x444.jpg" width="104" height="139" alt="리얼터"></span><em class="card_tit">리얼터</em></a><span class="card_txt">글 전진석, 김현희, 그림 최예지</span></div></li><li class="card_item col_type3"><div class="card"><a href="http://comics.hangame.com/titles/2340" onclick="clickcr(this, 'toon.content1-4','','',event);" target="hangameComics"><span class="card_img_box"><span class="card_mask"></span><img src="https://hangame-images.toastoven.net/hangame/main2016/comics/184_246/2340_kv332x444.jpg" width="104" height="139" alt="Rock City Blues (록시티 블루스)"></span><em class="card_tit">Rock City Blues (록시티 블루스)</em></a><span class="card_txt">최미르</span></div></li></ul>
    </div>
</div>
<script type="text/javascript">
...
<div class="plus_area half_type">
    <div class="tit_box">
        <h2 class="mix_tit"><a href="https://mix.hangame.com" onclick="clickcr(this, 'mix.logo','','',event);" target="hangameMixSite" class="tit_link"><span class="logo_mix">HANGAME mix</span></a></h2>
    </div>
    <div class="mix_box">
        <ul class="game_info_lst">
            
                <li class="game_info_item">
                    <a href="https://mix.hangame.com/game/10053" onclick="clickcr(this, 'mix.game1','','',event);" target="hangameMixSite" class="game_img_link">
                        <img src="https://hangame-images.toastoven.net/hangame/mix/v2/img/game/poker_app_icon_140.png" width="71" height="71" alt="한게임 포커 : 레볼루션">
                    </a>
                    <div class="game_info">
                        <a href="https://mix.hangame.com/game/10053" onclick="clickcr(this, 'mix.game1','','',event);" target="hangameMixSite" class="game_info_tit">한게임 포커 : 레볼루션</a>
                ...
                <li class="game_info_item">
                    <a href="https://mix.hangame.com/game/10475" onclick="clickcr(this, 'mix.game2','','',event);" target="hangameMixSite" class="game_img_link">
                        <img src="https://hangame-images.toastoven.net/hangame/mix/img/game/sudda_app_140_20190402.png" width="71" height="71" alt="한게임 섯다 :  레볼루션">
                    </a>
                    <div class="game_info">
                        <a href="https://mix.hangame.com/game/10475" onclick="clickcr(this, 'mix.game2','','',event);" target="hangameMixSite" class="game_info_tit">한게임 섯다 :  레볼루션</a>
                ...
                <li class="game_info_item">
                    <a href="http://lnc.kakao.hangame.com:10080/hsp/lnc/redirect/hsp/lnc/redirect?market=KG&amp;gameNo=10378" onclick="clickcr(this, 'mix.game3','','',event);" target="hangameMixSite" class="game_img_link">
                        <img src="https://hangame-images.toastoven.net/hangame/mix/img/game/duelgo_icon_86_86.png" width="71" height="71" alt="한게임 신맞고">
                    </a>
                    <div class="game_info">
                        <a href="http://lnc.kakao.hangame.com:10080/hsp/lnc/redirect/hsp/lnc/redirect?market=KG&amp;gameNo=10378" onclick="clickcr(this, 'mix.game3','','',event);" target="hangameMixSite" class="game_info_tit">한게임 신맞고</a>
                ...
                <li class="game_info_item">
                    <a href="http://lnc.kakao.hangame.com:10080/hsp/lnc/redirect/hsp/lnc/redirect?market=KG&amp;gameNo=10329" onclick="clickcr(this, 'mix.game4','','',event);" target="hangameMixSite" class="game_img_link">
                        <img src="https://hangame-images.toastoven.net/hangame/mix/img/game/002_crusadersquest_icon.png" width="71" height="71" alt="크루세이더 퀘스트">
                    </a>
                    <div class="game_info">
                        <a href="http://lnc.kakao.hangame.com:10080/hsp/lnc/redirect/hsp/lnc/redirect?market=KG&amp;gameNo=10329" onclick="clickcr(this, 'mix.game4','','',event);" target="hangameMixSite" class="game_info_tit">크루세이더 퀘스트</a>
                        <span class="game_info_txt">추억 속 명작 RPG의 감동</span>
                        <dl class="platform">
                            <dt class="blind">플레이 가능한 플랫폼</dt>
...
<div class="game_section">
	...
	<li class="card_item col_type1">
		...
		<a href="https://gostop.hangame.com/msduelgo.nhn" onclick="clickcr(this,'agl.thumblist', 'msduelgo', '1', event);" title="신맞고" target="_self">
			...
			<div class="card card_square">
				<span class="card_img_box">
					...
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/msduelgo.jpg" width="158" height="118" alt="신맞고" title="신맞고">
				</span>
	...
	<li class="card_item col_type1">
		...
		<a href="https://poker.hangame.com/index.nhn?gameid=baduki" onclick="clickcr(this,'agl.thumblist', 'baduki', '2', event);" title="로우바둑이" target="_self">
			...
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/baduki.jpg" width="158" height="118" alt="로우바둑이" title="로우바둑이">
				</span>
	...
	<li class="card_item col_type1">
		...
		<a href="https://baduk.hangame.com/" onclick="clickcr(this,'agl.thumblist', 'baduk', '3', event);" title="바둑" target="_self">
			...
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/baduk.jpg" width="158" height="118" alt="바둑" title="바둑">
				</span>
	...
	<li class="card_item col_type1">
		...
		<a href="http://gostop.hangame.com/gostop.nhn" onclick="clickcr(this,'agl.thumblist', 'gostop', '4', event);" title="고스톱" target="_self">
			
			
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/gostop.jpg" width="158" height="118" alt="고스톱" title="고스톱">
				</span>
	...
	<li class="card_item col_type1">
		...
		<a href="https://poker.hangame.com/index.nhn?gameid=poker7" onclick="clickcr(this,'agl.thumblist', 'poker7', '5', event);" title="7포커" target="_self">
			
			
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/poker7.jpg" width="158" height="118" alt="7포커" title="7포커">
				</span>
	...
	<li class="card_item col_type1">
		...
		<a href="http://mhorigin.hangame.com/" onclick="clickcr(this,'agl.thumblist', 'K_MHORIGIN', '6', event);" title="무협오리진" target="_self">
			...
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/온라인게임목록_MHORIGIN.jpg" width="158" height="118" alt="무협오리진" title="무협오리진">
				</span>
				<em class="card_tit">무협오리진</em>
				<span class="card_txt">14억명이 선택한 무협RPG</span>
			</div>
		</a>
	...
	<li class="card_item col_type1">
		...
		<a href="http://dark.hangame.com/" onclick="clickcr(this,'agl.thumblist', 'K_DARK', '7', event);" title="다크워" target="_self">
			...
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/온라인게임목록_DARK.jpg" width="158" height="118" alt="다크워" title="다크워">
				</span>
				<em class="card_tit">다크워</em>
				<span class="card_txt">어둠으로 가득찬 전쟁RPG</span>
			</div>
		</a>
	...
	<li class="card_item col_type1">
		...
		<a href="http://icarus.hangame.com" onclick="clickcr(this,'agl.thumblist', 'K_ICARUS', '8', event);" title="이카루스" target="_self">
			...
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/K_ICARUS.jpg" width="158" height="118" alt="이카루스" title="이카루스">
				</span>
				<em class="card_tit">이카루스</em>
				<span class="card_txt">가슴이 뛴다면 올라타라!</span>
			</div>
		</a>
	...
	<li class="card_item col_type1">
		...
		<a href="https://poker.hangame.com/index.nhn?gameid=highlow2" onclick="clickcr(this,'agl.thumblist', 'highlow2', '9', event);" title="하이로우" target="_self">
			
			
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/highlow2.jpg" width="158" height="118" alt="하이로우" title="하이로우">
				</span>
	...
	<li class="card_item col_type1">
		...
		<a href="http://gostop.hangame.com/gssudda.nhn" onclick="clickcr(this,'agl.thumblist', 'gssudda', '10', event);" title="섯다" target="_self">
			
			
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/gssudda.jpg" width="158" height="118" alt="섯다" title="섯다">
				</span>
	...
	<li class="card_item col_type1">
		...
		<a href="http://gostop.hangame.com/duelgo.nhn" onclick="clickcr(this,'agl.thumblist', 'duelgo', '11', event);" title="맞고" target="_self">
			
			
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/duelgo.jpg" width="158" height="118" alt="맞고" title="맞고">
				</span>
	...
	<li class="card_item col_type1">
		...
		<a href="https://janggi.hangame.com/" onclick="clickcr(this,'agl.thumblist', 'janggi', '12', event);" title="장기" target="_self">
			
			
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/janggi.jpg" width="158" height="118" alt="장기" title="장기">
				</span>
	...
	<li class="card_item col_type1">
		...
		<a href="http://tr.hangame.com/" onclick="clickcr(this,'agl.thumblist', 'TR', '13', event);" title="테일즈런너" target="_self">
			...
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/TR.jpg" width="158" height="118" alt="테일즈런너" title="테일즈런너">
				</span>
	...
	<li class="card_item col_type1">
		...
		<a href="http://ma9.hangame.com/main.asp" onclick="clickcr(this,'agl.thumblist', 'k_ma9', '14', event);" title="마구마구" target="_self">
			
			
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/k_ma9.jpg" width="158" height="118" alt="마구마구" title="마구마구">
				</span>
	...
	<li class="card_item col_type1">
		...
		<a href="http://pristontale.hangame.com" onclick="clickcr(this,'agl.thumblist', 'K_PRST', '15', event);" title="프리스톤테일" target="_self">
			
			
			<div class="card card_square">
				<span class="card_img_box">
					<span class="card_mask"></span>
					<img src="https://hangame-images.toastoven.net/hangame/main2016/game/www_online/K_PRST.jpg" width="158" height="118" alt="프리스톤테일" title="프리스톤테일">
				</span>
...
<!-- mini_banner_area -->
<div class="mini_banner_area">
    
    
    

    
    <a href="https://mini.hangame.com/index/pc?utm_source=hangame&amp;utm_medium=main_footer&amp;utm_campaign=open" target="_blank" onclick="" class="mini_banner">
        <!-- [D] 배너이미지 속 텍스트 내용을 alt 속성에 동일하게 입력 부탁드립니다 (접근성 이슈) -->
        <img src="https://hangame-images.toastoven.net/hangame/main2016/banner/top_bar/footer_mini_banner.jpg" alt="">
    </a>
</div>
<!-- //mini_banner_area -->
</div>
		...
		<div class="inner">
			...
			<ul class="service_lst">
				<li class="service_item">
					<a href="http://member.hangame.com/securitycenter.nhn?menuCode=hangame_otp_main" onclick="clickcr(this,'svc.otp','','',event);" class="service_link" title="한게임 OTP">
						한게임 OTP
				...
				<li class="service_item">
					<a href="https://hmember.hangame.com/shutdown/main.nhn?menuCode=pc_main" onclick="clickcr(this,'svc.ts','','',event);" class="service_link" title="게임시간 선택제">
						게임시간 선택제
					</a><span class="bar"></span></li>
				<li class="service_item">
				...
				<li class="service_item">
					<a href="#" class="service_link" onclick="openLayer('mobilePRLayer'); return false;">
						한게임 모바일웹 <span class="ico_mobile">모바일 가이드 보기</span>
					</a>
				</li>

			</ul>
			
			<a href="/siteMap.nhn" onclick="clickcr(this,'ftr.map','','',event);" class="service_more_link" title="서비스 전체보기"><strong>서비스 전체보기</strong></a>
		</div>
	</div>
	
	<div class="info_section">
		<div class="inner">
			<a href="http://www.nhn.com/" onclick="clickcr(this,'ftr.nhn','','',event);" target="_blank" class="nhnent_link" title="NHN"><em class="logo_nhn">NHN</em></a>
			<div class="info_area">
				<ul class="policy_lst">
